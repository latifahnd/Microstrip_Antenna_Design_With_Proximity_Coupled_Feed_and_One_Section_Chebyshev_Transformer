...
lifetime=s:rebuild
result=s:1
files=s:e-field (f=5.5)_1,1.m3d
...
lifetime=s:rebuild
result=s:1
files=s:h-field (f=5.5)_1,1.m3d
...
lifetime=s:surviveparchange
result=s:1
treepath=s:1D Results\Optimizer\Parameters\d1
files=s:para0.sig
...
lifetime=s:surviveparchange
result=s:1
treepath=s:1D Results\Optimizer\Parameters\Scaled\d1
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\H-Field\h-field (f=5.5) [1]
files=s:h-field (f=5.5)_1,1.m3d
files=s:h-field (f=5.5)_1,1_m3d.rex
ylabel=s:h-field (f=5.5) [1]
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\Surface Current\surface current (f=5.5) [1]
files=s:h-field (f=5.5)_1,1.m3d
files=s:h-field (f=5.5)_1,1_m3d_sct.rex
ylabel=s:surface current (f=5.5) [1]
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\E-Field\e-field (f=5.5) [1]
files=s:e-field (f=5.5)_1,1.m3d
files=s:e-field (f=5.5)_1,1_m3d.rex
ylabel=s:e-field (f=5.5) [1]
